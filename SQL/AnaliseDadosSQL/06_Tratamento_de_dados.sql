...
-- Criando uma nova coluna chamada posicao_tumor concatenando as colunas inv_nodes e quadrante.

CREATE TABLE db_cancer.tb_pacientes4
AS
SELECT
classe,
idade,
...
seio,
tamanho_tumor
FROM db_cancer.tb_pacientes3;

-- 3- Aplicando One-Hot-Encoding à coluna deg_malig.

SELECT DISTINCT deg_malig
FROM tb_pacientes4;

CREATE TABLE db_cancer.tb_pacientes5
AS
SELECT
classe,
idade,
...
seio,
tamanho_tumor
FROM db_cancer.tb_pacientes4;

-- 4- Criando um novo dataset com todas as variáveis após as transformações anteriores

-- botao direito na tabela tb_pacientes5 TABLE DATA EXPORT WIZARD -- BROWSER